		...
		<div class="row">
			...
			<div class="col-md-9">
				<ul>
					...
					<li><b>Description:</b> This is the last game in the series of three. Collect the DNA to progress through 30 levels. It's faster, crazier, more addicting, and near impossible!</li>
				</ul>
