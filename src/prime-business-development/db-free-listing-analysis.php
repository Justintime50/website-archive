...
/////
//
// Script enters free listing analysis info into the DB
//
/////
...
$sql = "INSERT INTO free_listing_analysis (name, email, phone, asin) VALUES ('$name', '$email', '$phone', '$asin');";



$query = mysqli_query($conn, $sql);
if($query) {
    include 'db-free-listing-analysis-email.php';
