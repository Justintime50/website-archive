        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="pa-well">
                    ...
                    <p class="text-center index-text">Send us your information and we'll analize your product listing,
                        for free! Receiving a listing analysis is a great way to measure your progress and to see what
                        you can improve upon.</p>
                ...
                <div class="pa-well">
                    ...
                    <form action="#" method="post">
                        ...
                        <button type="submit" class="btn btn-danger btn-lg text-center"
                            style="width: 100%;" disabled>Submit</button>
                </div>
                </form>
