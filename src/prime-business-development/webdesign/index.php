...
<body id="home" data-spy="scroll" data-target=".navbar" data-offset="70">
    <nav class="navbar navbar-inverse navbar-toggleable-lg fixed-top">
        ...
        <img src="assets/pics/webdesign_logo.png" class="logo" alt="Logo">
        </a>
        <div class="collapse navbar-collapse justify-content-end" id="myNavbar">
            <ul class="navbar-nav">
                <li class="nav-item" style="padding-right: 30px;"><a class="nav-link" href="tel:NA">FREE QUOTE: 801-555-1234</a>
                </li>
    ...
    <div class="container-fluid">
        ...
        <div class="row pa-slideanim">
            ...
            <div class="col-sm-6 text-center">
                <p>We design our sites with every user in mind. All of our sites are built with a mobile-first approach
                    meaning that we design for all screen sizes. We've tested our sites on devices as small as an iPhone
                    5 to a 60" TV!</p>
            </div>
    ...
    <div class="container-fluid pa-bg-gray">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-7 pa-slideanim text-left">
                <h3>Hosting</h3>
                <p>We run our server in-house so we can give you attention to detail. We'll take care of all your sites
                    maintenance so you can focus on your business.</p>
                <hr>
                <h3>Speed</h3>
                <p>All of our sites run on their own dedicated <a
                        href="https://en.wikipedia.org/wiki/Content_delivery_network" target="_blank">CDN</a> so that
                    your site loads instantaneously. Our server is loaded with hardware more than capable of handling
                    any influx of traffic.</p>
                <hr><br>
            </div>

            <div class="col-md-8 pa-slideanim text-left">
                <h3>Uptime</h3>
                <p>For years we've accomplished an incredible 99% uptime. Your site will always be accesible, rain or
                    shine.</p>
                <hr>
                <h3>Security</h3>
                <p>We are dedicated to your companies and customers security. All of our websites come with their own
                    SSL certificate - free of charge. This allows traffic to be encrypted end to end so that your data
                    is kept safe.</p>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row text-center">
            ...
            <div class="col-sm-4 pa-slideanim">
                <p style="font-size: 28px">We've created images, databases, login systems, shopping platforms,
                    client/employee backends and more.</p>
            </div>
    ...
    <div id="get-started" class="container text-center bg-grey">
        ...
        <hr>
        <p style="font-size: 3vmin">801-555-1234</p>
        <br>
        <p style="font-size: 3vmin">user@example.com</p>
        <br><br>
    </div>
