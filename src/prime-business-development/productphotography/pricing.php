...
<body id="home" data-spy="scroll" data-target=".navbar" data-offset="70">
    ...
    <div id="how-it-works" class="container">
        ...
        <p>The price of each photo is determined by the base price, plus upgrades. The more photos you order at a time,
            the lower the cost per photo.</p>
        ...
        <div class="text-center">
            <a href="#"><button
                    class="btn btn-default btn-lg btn-other" style="background-color: #89150a;color: #fff;">START YOUR
                    ORDER</button></a>
        </div>
    </div>
    ...
    <div id="upgrades" class="pa-bg-gray" style="width: 100%;">
        <div class="container">
            ...
            <div class="text-center">
                <a href="#"><button
                        class="btn btn-default btn-lg btn-other" style="background-color: #89150a;color: #fff;">START
                        YOUR ORDER</button></a>
            </div>
    ...
    <div class="text-center">
        ...
        <a href="#"><button class="btn btn-default btn-lg btn-other"
                style="background-color: #89150a;color: #fff;">START YOUR ORDER</button></a>
    </div>
    <br><br>
    </div>
