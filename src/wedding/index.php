...
<div id="proposal" class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-5">
      <img src="assets/kneel.jpg" style="max-width:100%;">
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-sm-5">
      <img src="assets/ring.jpg" style="max-width:100%;">
    </div>
    <div class="col-sm-7">
...
<div id="ourstory" class="container-fluid bg-grey">
  ...
  <div class="row">
    ...
    <div class="col-sm-5">
      <img src="assets/banner-small.jpg" style="max-width:100%;">
    </div>
  </div>
</div>
...
<div id="registry" class="container-fluid bg-grey text-center">
  <h2 class="text-center">Gift Registry</h2><br>
      <div class="row">
        <div class="col-sm-6">
          <a href="#" target="_blank"><button class="btn btn-default btn-lg btn-other">Bed Bath &#38; Beyond Registry</button></a> 
        </div>
        <div class="col-sm-6">
          <a href="#" target="_blank"><button class="btn btn-default btn-lg btn-other">Amazon Registry</button></a>
        </div>
      </div>
    </div>
  </div>
